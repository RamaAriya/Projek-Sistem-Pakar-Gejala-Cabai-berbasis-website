...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="diagnosa.php"><button type="button" class="btn btn-success btn-block active">DIAGNOSA PENYAKIT</button></a></p>
      <p><a href="daftarpenyakit.php"><button type="button" class="btn btn-success btn-block">DAFTAR PENYAKIT</button></a></p>
      <p><a href="about.php"><button type="button" class="btn btn-success btn-block">ABOUT</button></a></p>
    ...
    <div class="col-sm-8 text-left" style="margin: 80px; margin-top: 20px; font-family: garamond;"> 
      <center><h2>DIAGNOSA PENYAKIT</h2></center><br>
       ...
       <br>     
        ...
        <br>
        <button type="submit" name ="submit" onclick="return checkDiagnosa()" class="btn btn-warning">CEK PENYAKIT</button><br><br>
