...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" style="margin: 80px; margin-top: 20px; font-family: garamond;">
        <h2 class="text-center">INPUT GEJALA</h2><br>
      <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="ainputgejala.php">
          ...
          <div class="form-group ">
                ...
                <button type="submit" name ="submit" class="btn btn-warning" style="margin: 150px; margin-top:27px; margin-bottom:90px">Simpan</button>
          <?php			
