...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h2 class="text-center" >EDIT HAMA DAN PENYAKIT</h2><br>
    <form method="post">
     ...
     <button type="submit" name ="submit" class="btn btn-warning" style="margin: 160px; margin-top: 40px; margin-bottom:-50px">Simpan</button>
         <?php
