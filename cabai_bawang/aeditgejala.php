...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="gejala.php"><button type="button" class="btn btn-success btn-block active">GEJALA</button></a></p>
    ...
    <div class="col-sm-8 text-left" style="font-family: garamond; margin: 80px; margin-top: 20px;"> 
      <h2 class="text-center">EDIT GEJALA</h2><br>
    <form method="post">
      <div class="form-group">
        ...
        <button type="submit" name ="submit" class="btn btn-warning" style="margin:160px; margin-top: 30px; margin-bottom:-100px">Simpan</button>
         <?php
