...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="daftarpenyakit.php"><button type="button" class="btn btn-success btn-block active">DAFTAR PENYAKIT</button></a></p>
    ...
    <div class="col-sm-8 text-left" style="margin: 80px; margin-top: 20px; font-family: garamond;"> 
      <h2 class="text-center">DETAIL HAMA DAN PENYAKIT</h2><br>
