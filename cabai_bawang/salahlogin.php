...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <p><a href="index.php"><button type="button" class="btn btn-success btn-block active">BERANDA</button></a></p>
    ...
    <div class="col-sm-8 text-left" style="margin: 80px; margin-top: 20px; font-family: garamond;"> 
      ...
      <center><h3>Menentukan Diagnosa Hama dan Penyakit <br> Tanaman Bawang dan Cabai </h3></center>
      <br>
    <div class="alert alert-danger alert-dismissible" id="alert">
        ...
        <div class="panel panel-info">
                <div class="panel-heading" style="background-color: #48BE1C;"></div>
