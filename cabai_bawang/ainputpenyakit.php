...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" style="margin: 80px; margin-top: 20px; font-family: garamond;"> >
        <h2 class="text-center">INPUT HAMA DAN PENYAKIT</h2> <br>
      <form class="form-horizontal" method="post" data-toggle="validator" role="form" action="ainputpenyakit.php">
          ...
          <button type="submit" name ="submit" class="btn btn-warning" style="margin:150px; margin-top: 40px; margin-bottom:-40px">Simpan</button><br>
          <?php		
