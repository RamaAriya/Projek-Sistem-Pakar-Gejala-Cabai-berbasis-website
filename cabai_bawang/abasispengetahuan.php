...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><a href="basispengetahuan.php"><button type="button" class="btn btn-success btn-block active">BASIS PENGETAHUAN</button></a></p>
    ...
    <div class="col-sm-8 text-left" style="font-family: garamond; margin: 80px; margin-top: 20px; "> 
        <h2 class="text-center">BASIS PENGETAHUAN</h2><br>
    ...
    <br><button type="submit" name ="submit" class="btn btn-warning" style="margin: 2px; margin-top: 10px; margin-bottom:-50px;">Simpan</button>
     <?php			
